...
public class GPUImageAntiqueFilter extends GPUImageFilter {
	private int[] mToneCurveTexture = {-1};
	private int mToneCurveTextureUniformLocation;
	  
	public GPUImageAntiqueFilter(){
		super(NO_FILTER_VERTEX_SHADER, OpenGlUtils.readTextFromRawResource(DogApplication.getInstance(), R.raw.antique));
	}
