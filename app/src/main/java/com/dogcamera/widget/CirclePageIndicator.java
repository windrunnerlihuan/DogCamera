...
/**
 * Created by huanli on 2017/11/23.
 */
...
public class CirclePageIndicator extends View implements ViewPager.OnPageChangeListener {
    ...
    public CirclePageIndicator(Context context, AttributeSet attrs) {
        ...
        final int defaultPageColor = Color.parseColor("#666666");
        final int defaultFillColor = Color.parseColor("#FFFFFFFF");
        final int defaultOrientation = 0;
        final int defaultStrokeColor = Color.parseColor("#666666");
        final float defaultStrokeWidth = 0f;
        final float defaultRadius = ViewUtils.dip2px(context, 3);
    ...
    public void setViewPagerForce(ViewPager view){
        if (mViewPager != null) {
